...
public class quartz3 implements Job {
	Calendar c = Calendar.getInstance();
	// ①实例Job接口方法
	public void execute(JobExecutionContext jobCtx)
			throws JobExecutionException {

		CronTriggerRunner3.shutdown();
...
//			String path = "D:\\YouE\\雄安\\db";
			...
			//导出数据库ip
			String cmd = "mysqldump -h192.168.0.135 -uroot -p123456 --databases xa-datadir xiongan xiongan_appback xiongan_operationback xiongan_personback > " + fileName + ".sql";
			//删除最老大于7个的数据
...
//			runSSH("192.168.102.216", "root", "Bigdata@2017#", cmd);
			runSSH("192.168.0.135", "root", "Bigdata@2017#", cmd);
	...
	private void runCmd()   {
		...
		long start = System.currentTimeMillis();
		try {
			String sql = "mysqldump -h192.168.0.135 -uroot -p123456 --databases xa-datadir xiongan xiongan_appback xiongan_operationback xiongan_personback  > " + fileName + ".sql" ;
