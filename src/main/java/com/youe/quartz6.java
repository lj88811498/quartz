...
public class quartz6 implements Job {
...
//		String localPath =  "D:\\YouE\\雄安\\db\\";
		String localPath =  "D:\\YouE\\南宁云app\\db\\back\\";
		int day = c.get(Calendar.DAY_OF_MONTH);
		int month = c.get(Calendar.MONTH) + 1;
		String fileName = localPath + "/one" + "-" +  month + "-" + day + "-" + System.currentTimeMillis();
		long start = System.currentTimeMillis();
		try {
//			String sql = "mysqldump -h172.16.0.5 -uroot -p1qaz@WSX --databases  nncloud > " + fileName + ".sql" ;
			String sql = "mysqldump -h47.92.158.92 -uroot -proot --databases  one > " + fileName + ".sql" ;
