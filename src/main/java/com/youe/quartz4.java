...
public class quartz4 implements Job {
...
//			String path = "/home/cdyoue";
			//linux地址
			String path = "/home/cdyoue/fx";
			//本地地址
//			String path = "D:\\YouE\\雄安\\db";
			//数据库名
			String fileName = path + "/fx" + "-" + month + "-" + day + "-" + System.currentTimeMillis();
			//String command = "/bin/sh " + shpath + " "  + fileName;
			//导出数据库ip
			String cmd = "mysqldump -h172.16.0.5 -uroot -p1qaz@WSX --databases fx > " + fileName + ".sql";
			//删除最老大于7个的数据
...
//			runSSH("192.168.102.216", "root", "Bigdata@2017#", cmd);
			runSSH("172.16.0.5", "root", "Abc123456", cmd);
